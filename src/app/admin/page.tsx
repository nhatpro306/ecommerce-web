...
export default function AdminDashboard() {
  ...
  const displayName = useMemo(() => {
    ...
    const fromMeta = (meta?.full_name as string | undefined) || (meta?.name as string | undefined);
  ...
  if (adminError || !isAdmin) {
    return (
      <div className="mx-auto max-w-3xl px-4 py-14 text-center">
        ...
        <p className="mt-4 text-zinc-600">Tài khoản của bạn không có quyền admin.</p>
        <Link href="/dashboard">
