...
export const storeSettingsSchema = z.object({
  ...
  hero_primary_button_text: z.string().optional(),
  hero_primary_button_url: z.string().url().optional().or(z.literal("")),
  hero_secondary_button_text: z.string().optional(),
  hero_secondary_button_url: z.string().url().optional().or(z.literal("")),
