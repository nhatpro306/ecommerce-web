...
const dictionary: I18nDictionary = {
  vi: {
    ...
    "orders.customerDetailsTitle": "Chi tiết đơn hàng",
    "orders.customerDetailsDescription":
      "Thông tin khách hàng, địa chỉ giao hàng, thanh toán và sản phẩm.",
    "orders.customerName": "Tên",
    "orders.email": "Email",
    "orders.phone": "Số điện thoại",
    "orders.note": "Ghi chú",
    "orders.none": "Không có",
    "orders.notProvided": "Chưa cung cấp",
    "orders.shippingAddress": "Địa chỉ giao hàng",
    "orders.products": "Sản phẩm",
    "orders.loadingProducts": "Đang tải sản phẩm...",
    "orders.notFoundProducts": "Không tìm thấy sản phẩm trong đơn hàng.",
    "orders.cancelOrder": "Hủy đơn hàng",
    "orders.deleteOrder": "Xóa đơn hàng",
    ...
    "success.paymentMethod": "Phương thức thanh toán",
    "success.orderCode": "Mã đơn hàng",
    "success.totalAmount": "Tổng thanh toán",
    "success.pleaseWaitConfirm": "Vui lòng chờ trong khi hệ thống xác nhận đơn hàng.",
    "success.bankContent": "Nội dung",

    "clientProducts.searchPlaceholder": "Tìm sản phẩm...",
    "clientProducts.showing": "Hiển thị {shown}/{total} sản phẩm",
    "clientProducts.updating": "Đang cập nhật...",
    "clientProducts.clearFilters": "Xóa bộ lọc",
    "clientProducts.loadingProducts": "Đang tải sản phẩm...",
    "clientProducts.loadFailTitle": "Không thể tải sản phẩm",
    "clientProducts.loadFailDesc":
      "Không thể tải danh sách sản phẩm. Vui lòng thử lại hoặc kiểm tra cấu hình môi trường.",
    "clientProducts.emptyTitle": "Chưa có sản phẩm",
    "clientProducts.noMatchTitle": "Không có sản phẩm phù hợp",
    "clientProducts.emptyDesc": "Hiện chưa có sản phẩm nào hiển thị trên cửa hàng.",
    "clientProducts.noMatchDesc": "Thử từ khóa khác hoặc điều chỉnh bộ lọc để xem thêm sản phẩm.",
    "clientProducts.clearAllFilters": "Xóa toàn bộ bộ lọc",
    "clientProducts.allCategories": "Tất cả danh mục",
    "clientProducts.allSizes": "Tất cả size",
    "clientProducts.allColors": "Tất cả màu",
  ...
  en: {
    ...
    "orders.customerDetailsTitle": "Order details",
    "orders.customerDetailsDescription":
      "Customer profile, shipping address, payment and purchased items.",
    ...
    "orders.loadingProducts": "Loading products...",
    "orders.notFoundProducts": "No products found in this order.",
    ...
    "success.pleaseWaitConfirm": "Please wait while we confirm your order.",
    "success.bankContent": "Transfer content",

    "clientProducts.searchPlaceholder": "Search products...",
    "clientProducts.showing": "Showing {shown}/{total} products",
    "clientProducts.updating": "Updating...",
    "clientProducts.clearFilters": "Clear filters",
    "clientProducts.loadingProducts": "Loading products...",
    "clientProducts.loadFailTitle": "Could not load products",
    "clientProducts.loadFailDesc":
      "Could not load products from Supabase. Please try again or check environment configuration.",
    "clientProducts.emptyTitle": "No products yet",
    "clientProducts.noMatchTitle": "No matching products",
    "clientProducts.emptyDesc": "There are no products visible on the storefront yet.",
    "clientProducts.noMatchDesc": "Try another keyword or adjust your filters.",
    "clientProducts.clearAllFilters": "Clear all filters",
    "clientProducts.allCategories": "All categories",
    "clientProducts.allSizes": "All sizes",
    "clientProducts.allColors": "All colors",
